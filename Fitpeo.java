...
public class Fitpeo{
	public static void main(String args[]) throws InterruptedException{
		...
		if(Browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver","C:\\Users\\win10\\Downloads\\Drivers\\chromedriver-win64\\chromedriver.exe");
		...
		//if the browser name is Firefox the below block will execute
			...
			System.setProperty("webdriver.gecko.driver","C:\\Users\\win10\\Downloads\\Drivers\\Firefox Driver\\geckodriver.exe");
		...
		//if the browser name is Edge the below block will execute
			...
			System.setProperty("webdriver.edge.driver","C:\\Users\\win10\\Downloads\\Drivers\\Edge Driver\\msedgedriver.exe");
		...
		for (String windowHandle : Windows) { 
			...
			if(!windowHandle.equals(ParentWindow)) {
				...
				driver.findElement(By.xpath("//form/div/input")).sendKeys("sachinb1696@gmail.com"); //Sending an email address to the field
				//driver.findElement(By.xpath("//button/span[text()='CONTINUE']")).click();  //Clicking on the Continue button
			//	driver.findElement(By.xpath("//*[@class=\"_2IX_2- _17N0em\"]")).sendKeys("8073421442");
				driver.findElement(By.xpath("//button/span[text()='CONTINUE']")).click();  //Clicking on the Continue button
				driver.findElement(By.xpath("//*[@class=\"_2IX_2- _3mctLh _17N0em\"]")).click(); 
				driver.close();
			}
		}
